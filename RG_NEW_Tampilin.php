      ...
      <?php do { ?>
        <tr>
          <td><div align="center"><br>
              Silahkan Login Dengan Email /<em><strong> <a href="LOGIN.php"><?php echo $row_Recordset1['email']; ?></a></strong></em><br>
          </div></td>
        </tr>
        <tr>
          <td><div align="center"><a href="RG_NEW_Edit.php?ID=<?php echo $row_Recordset1['ID']; ?>"><img src="img web/icon (2).png" width="25" height="25"></a><a href="RG_NEW_Delete.php?ID=<?php echo $row_Recordset1['ID']; ?>"><img src="img web/icon (1).png" width="25" height="25"></a></div></td>
        </tr>
      ...
      <table width="406" align="center">
        ...
        <tr valign="baseline">
          ...
          <td><button type="submit" class="btn btn-secondary btn-sm">Registrasi</button>
            ...
            <a href="RG_NEW_Inputan.php"><img src="img web/11.png" width="39" height="39"></a></td>
        </tr>
      </table>
